...
def get_data():
    ...
    assay_df = assay_df[assay_df['assay_organism'].isin(bacterial_species)]

    get_activity = """
    SELECT
        ACTIVITIES.activity_id,
        ACTIVITIES.assay_id as id,
        ACTIVITIES.standard_relation,
        ACTIVITIES.standard_type,
        ACTIVITIES.standard_value,
        ACTIVITIES.standard_units,
        ACTIVITIES.molregno as mol_id
    FROM ACTIVITIES
    """
    ...
    get_compounds = """
        SELECT
            MOLECULE_DICTIONARY.molregno as mol_id,
